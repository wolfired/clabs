...
typedef void (*line_stepper)(void* voidargs, int32_t x, int32_t y);

typedef void (*line_painter)(int32_t x0, int32_t y0, int32_t x1, int32_t y1, line_stepper stepper, void* voidargs);
